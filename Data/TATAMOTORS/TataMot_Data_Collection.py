...
def Tatamotors_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/TATAMOTORS.NS/history?p=TATAMOTORS.NS")
    print(driver.title)
...
def tatmotr_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/TATAMOTORS_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/TATAMOTORS_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/TATAMOTORS.NS.csv"
