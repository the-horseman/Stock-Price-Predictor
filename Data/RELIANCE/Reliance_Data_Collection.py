...
def Rel_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/RELIANCE.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/RELIANCE.NS (1).csv"
...
def Rel_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/RELIANCE_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/RELIANCE_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/RELIANCE.NS.csv"
