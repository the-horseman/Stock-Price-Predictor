...
def HDFC_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/HDFCBANK.NS/history?p=HDFCBANK.NS")
    print(driver.title)
...
def Hdfc_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/HDFCBANK.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/HDFCBANK.NS (1).csv"
...
def Hdfc_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/HDFCBANK_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/HDFCBANK_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/HDFCBANK.NS.csv"
