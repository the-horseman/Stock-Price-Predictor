...
def ICICI_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/ICICIBANK.NS/history?p=ICICIBANK.NS")
    print(driver.title)
...
def icici_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/ICICIBANK.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/ICICIBANK.NS (1).csv"
...
def icici_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/ICICIBANK_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/ICICIBANK_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/ICICIBANK.NS.csv"
