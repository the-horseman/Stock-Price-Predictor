...
def Wipro_data():
    ...
    driver.get("https://finance.yahoo.com/quote/WIPRO.NS/history?p=WIPRO.NS")
    print(driver.title)
...
def Wpro_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/WIPRO.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/WIPRO.NS (1).csv"
...
def Wpro_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/WIPRO_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/WIPRO_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/WIPRO.NS.csv"
