...
def Tatasteel_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/TATASTEEL.NS/history?p=TATASTEEL.NS")
    print(driver.title)
...
def Tatstl_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/TATASTEEL.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/TATASTEEL.NS (1).csv"
...
def Tatstl_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/TATASTEEL_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/TATASTEEL_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/TATASTEEL.NS.csv"
