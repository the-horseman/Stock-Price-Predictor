...
def Jubl_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/JUBLFOOD.NS/history?p=JUBLFOOD.NS")
    print(driver.title)
...
def jblFood_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/JUBLFOOD.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/JUBLFOOD.NS (1).csv"
...
def jblFood_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/JUBLFOOD_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/JUBLFOOD_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/JUBLFOOD.NS.csv"
