...
def Bel_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/BEL.NS/history?p=BEL.NS")
    print(driver.title)
...
def bel_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/BEL.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/BEL.NS (1).csv"
...
def bel_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/BEL_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/BEL_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/BEL.NS.csv"
