...
def LNT_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/LT.NS/history?p=LT.NS")
    print(driver.title)
...
def LNT_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/LT_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/LT_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/LT.NS.csv"
