...
def BnkOfBaroda_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/BANKBARODA.NS/history?p=BANKBARODA.NS")
    print(driver.title)
...
def BnkBaroda_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/BANKBARODA.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/BANKBARODA.NS (1).csv"
...
def BnkBaroda_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/BANKBARODA_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/BANKBARODA_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/BANKBARODA.NS.csv"
