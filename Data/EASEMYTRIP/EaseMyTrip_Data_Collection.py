...
def EaseMyTrip_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/EASEMYTRIP.NS/history?p=EASEMYTRIP.NS")
    print(driver.title)
...
def esemytrp_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/EASEMYTRIP.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/EASEMYTRIP.NS (1).csv"
...
def esemytrp_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/EASEMYTRIP_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/EASEMYTRIP_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/EASEMYTRIP.NS.csv"
