...
def Kpit_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/KPITTECH_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/KPITTECH_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/KPITTECH.NS.csv"
