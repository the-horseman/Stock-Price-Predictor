...
def GHCL_Data():
    ...
    driver.get("https://finance.yahoo.com/quote/GHCL.NS/history?p=GHCL.NS")
    print(driver.title)
...
def GHCL_data_add():
    path1 = os.path.dirname(os.path.realpath(__file__)) + "/GHCL.NS.csv"
    path2 = os.path.dirname(os.path.realpath(__file__)) + "/GHCL.NS (1).csv"
...
def GHCL_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/GHCL_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/GHCL_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/GHCL.NS.csv"
