...
def AxisBnk_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/AXISBANK_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/AXISBANK_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/AXISBANK.NS.csv"
