...
def CanraBnk_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/CANBK_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/CANBK_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/CANBK.NS.csv"
