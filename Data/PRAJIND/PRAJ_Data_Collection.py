...
def PrajInd_train():
    ...
    sc_path = os.path.dirname(os.path.realpath(__file__)) + "/PRAJIND_scaler.pkl"
    md_path = os.path.dirname(os.path.realpath(__file__)) + "/PRAJIND_model.h5"
    fil_path = os.path.dirname(os.path.realpath(__file__)) + "/PRAJIND.NS.csv"
